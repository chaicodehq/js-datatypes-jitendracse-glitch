...
export function iplAuctionSummary(team, players) {
  ...
  // Find costliest and cheapest player
  ...
  return {
    ...
    costliestPlayer: { name: costliestPlayer.name, role: costliestPlayer.role, price: costliestPlayer.price },
    cheapestPlayer: { name: cheapestPlayer.name, role: cheapestPlayer.role, price: cheapestPlayer.price },
